...
const Trivia = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:3001/api/sashaData');
...
const data = [
  ...
  { Name: "Cléa", Year: 2004, Nationality:"French", Boobs: 5, Ass: 8, BJ:9, Intell:4, Location: "Club", Sex:8, Complicity:6, Special:"Tattoos", Grade: 15 },
];